  ...
  return (
    <div className='footer'>
        <div className="row p-4">
          ...
          <div className="contact col w-auto text-center">
            <h2>Contact Us</h2>
          ...
          <div className="social col w-auto text-center">
            <h2> Follow Us </h2>
            <ul>
