...
import DisplayAnnouncement from "./Components/Class Scheduling and Announcement Handling/announceStu/DisplayAnnouncement.jsx";

const App = () => {
  const [admin, setAdmin] = useState(null);

  useEffect(() => {
    const unsubscribe = getLoggedInAdmin()
      .then((res) => {
    ...
    <Router>
      <AdminContext.Provider value={{ admin, setAdmin }}>
        <Routes>
          ...
          <Route path="/bsmarks" element={<BSMarks />}>
            {" "}
          </Route>
          <Route path="/createbsmarks" element={<CreateBSMarks />}>
            {" "}
          </Route>
          <Route path="/updatebsmarks/:id" element={<UpdateBSMarks />}>
            {" "}
          </Route>
          ...
          <Route path="/updateStudent/:id" element={<UpdateProfile />}>
            {" "}
          </Route>
          ...
          <Route path="/display" element={<DisplayAnnouncement />}></Route>
        </Routes>
